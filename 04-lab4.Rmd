...
\begin{align}
e(\infty) = \lim\limits_{t \to \infty}{e(t)} = e_r(\infty) - y_w(\infty), (\#eq:eq1)
\end{align}
...
Observamos que a Tabela 1 e a Tabela 2 são válidas apenas para sistemas com realimentação unitária com perturbação na saída (veja a Figura 1) e tais que a Função de Transferência em malha-fechada é estável para $w=0$.

$$
\begin{array}{|c|c|c|c|} \hline
\text{Sistema } G(s) \text{ / Referência} & r(t) = A & r(t) = Bt & r(t) = Ct^2 \\ \hline
\text{Tipo 0} & \frac{A}{1 + K_p} & \infty & \infty \\\hline
\text{Tipo 1} & 0 & \frac{B}{K_v} & \infty \\\hline
\text{Tipo 2} & 0 & 0 & \frac{2C}{K_a} \\\hline
\end{array}
$$
