...
a. Determine $y(\infty) = y(\infty)$ por simulação para $w =1$ (degrau unitário) e $r=0$. Compare com a Tabela \@ref(tab:tab2).
...
c. Considere que $r(t) = 2t$ (rampa) e $w=0$. Determine $e(\infty) = e_r(\infty)$ por simulação e compare com a Tabela \@ref(tab:tab1).
d. Considere que $r(t) = 0$ e $w=t$ (rampa). Determine $y(\infty) = y_w(\infty)$ por simulação e compare com a Tabela \@ref(tab:tab2).
