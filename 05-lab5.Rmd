...
**Teorema 1** (Teorema do Valor Final). Seja $X(s)$ a Transformada de Laplace de um sinal $x(t)$. Suponha que $X(s)$ ou $sX(s)$ tem todos os pólos no SPE. Então, o limite $x(\infty) = \lim\limits_{t \to \infty}{x(t)}$ existe e é dado por
$$
...
## Procedimentos do Laboratório 5 {-}
