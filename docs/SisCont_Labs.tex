...
\addcontentsline{toc}{section}{Problema 10.1}
...
\addcontentsline{toc}{section}{Problema 10.2}
...
\addcontentsline{toc}{section}{Problema 10.3}
...
\hypertarget{parte-a-15}{%
\paragraph{Parte A}\label{parte-a-15}}
\addcontentsline{toc}{paragraph}{Parte A}
...
{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig9a} 

}

\caption{Resultado para $K = 1$}\label{fig:fig10RC1}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig10a} 

}

\caption{Resultado para $K = 10$}\label{fig:fig10RC2}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig11a} 

}

\caption{Resultado para $K = 40$}\label{fig:fig10RC3}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig12a} 

}

\caption{Resultado para $K = 60$}\label{fig:fig10RC4}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig13a} 

}

\caption{Resultado para $K = 80$}\label{fig:fig10RC5}
\end{figure}

\hypertarget{parte-b-15}{%
\paragraph{Parte B}\label{parte-b-15}}
\addcontentsline{toc}{paragraph}{Parte B}
...
{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig9b} 

}

\caption{Resultado para $K = 1$}\label{fig:fig10RC6}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig10b} 

}

\caption{Resultado para $K = 10$}\label{fig:fig10RC7}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig11b} 

}

\caption{Resultado para $K = 40$}\label{fig:fig10RC8}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig12b} 

}

\caption{Resultado para $K = 60$}\label{fig:fig10RC9}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig13b} 

}

\caption{Resultado para $K = 80$}\label{fig:fig10RC10}
\end{figure}

\hypertarget{problema-10.4}{%
\section*{Problema 10.4}\label{problema-10.4}}
\addcontentsline{toc}{section}{Problema 10.4}
...
\hypertarget{parte-a-16}{%
\paragraph{Parte A}\label{parte-a-16}}
\addcontentsline{toc}{paragraph}{Parte A}
...
{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig14} 

}

\caption{Resultado A}\label{fig:fig10RCD1}
\end{figure}
...
{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig16a} 

}

\caption{Resultado para $K = 0.1$}\label{fig:fig10RCD2}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig16b} 

}

\caption{Resultado para $K = 0.1$}\label{fig:fig10RCD3}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig17a} 

}

\caption{Resultado para $K = 1$}\label{fig:fig10RCD4}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig17b} 

}

\caption{Resultado para $K = 1$}\label{fig:fig10RCD5}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig18a} 

}

\caption{Resultado para $K = 50$}\label{fig:fig10RCD6}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig18b} 

}

\caption{Resultado para $K = 50$}\label{fig:fig10RCD7}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig19a} 

}

\caption{Resultado para $K = 200$}\label{fig:fig10RCD8}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig19b} 

}

\caption{Resultado para $K = 200$}\label{fig:fig10RCD9}
\end{figure}

\hypertarget{parte-b-16}{%
\paragraph{Parte B}\label{parte-b-16}}
\addcontentsline{toc}{paragraph}{Parte B}
...
\{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig20}

\}

\textbackslash caption\{MF\$\}\label{fig:fig10RCD10}
\textbackslash end\{figure\}

\textbackslash begin\{figure\}

\{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig20b}

\}

\textbackslash caption\{LR\$\}\label{fig:fig10RCD11}
\textbackslash end\{figure\}

\hypertarget{parte-c-11}{%
\paragraph{Parte C}\label{parte-c-11}}
\addcontentsline{toc}{paragraph}{Parte C}
...
\{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig21a}

\}

\textbackslash caption\{MF\$\}\label{fig:fig10RCD12}
\textbackslash end\{figure\}

\textbackslash begin\{figure\}

\{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig21b}

\}

\textbackslash caption\{LR\$\}\label{fig:fig10RCD13}
\textbackslash end\{figure\}

\hypertarget{problema-10.5}{%
\section*{Problema 10.5}\label{problema-10.5}}
\addcontentsline{toc}{section}{Problema 10.5}
...
\hypertarget{parte-a-17}{%
\paragraph{Parte A}\label{parte-a-17}}
\addcontentsline{toc}{paragraph}{Parte A}
...
{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig22a} 

}

\caption{LR}\label{fig:fig10REA1}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig22b} 

}

\caption{Bode}\label{fig:fig10REA2}
\end{figure}

\hypertarget{parte-b-17}{%
\paragraph{Parte B}\label{parte-b-17}}
\addcontentsline{toc}{paragraph}{Parte B}

Working on it :)

\hypertarget{parte-c-12}{%
\paragraph{Parte C}\label{parte-c-12}}
\addcontentsline{toc}{paragraph}{Parte C}
...
{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig23a} 

}

\caption{LR}\label{fig:fig10REC1}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab10/Resolução/fig23b} 

}

\caption{Bode}\label{fig:fig10REC2}
\end{figure}
...
Utilize o pacote \texttt{rltool} do Matlab para projetar os controladores dos
problemas abaixo com base no digrama de Bode.

\hypertarget{problema-11.1}{%
\section*{Problema 11.1}\label{problema-11.1}}
\addcontentsline{toc}{section}{Problema 11.1}
...
\tightlist
\item
  Determine um controlador avanço de fase \(C(s)\) considerando que: (i) \(MF \geq 60^\circ\) e (ii) \(K_v \geq10\).
\item
  Verifique que o controlador obtido realmente atende tais especificações.
\item
  Determine \(t_s(5\%)\) e a largura de banda \(\omega_{LB}\) de malha-fechada (\texttt{Analysis} \(\to\) \texttt{Closed-Loop\ Bode}).
\end{enumerate}

\hypertarget{resoluuxe7uxe3o-39}{%
\subsubsection*{Resolução}\label{resoluuxe7uxe3o-39}}
\addcontentsline{toc}{subsubsection}{Resolução}

\hypertarget{parte-a-18}{%
\paragraph{Parte A}\label{parte-a-18}}
\addcontentsline{toc}{paragraph}{Parte A}
...
{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab11/Resolução/fig1} 

}

\caption{Resultado A}\label{fig:fig11RA1}
\end{figure}
...
\[
C(s) = 20\frac{0.1937984s +1}{0.0193798s+1}
\]

\hypertarget{parte-b-18}{%
\paragraph{Parte B}\label{parte-b-18}}
\addcontentsline{toc}{paragraph}{Parte B}
...
{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab11/Resolução/fig2} 

}

\caption{Diagrama de Bode}\label{fig:fig11RA2}
\end{figure}
...
{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab11/Resolução/fig3} 

}

\caption{Simulação}\label{fig:fig11RA3}
\end{figure}

\hypertarget{parte-c-13}{%
\paragraph{Parte C}\label{parte-c-13}}
\addcontentsline{toc}{paragraph}{Parte C}
...
\{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab11/Resolução/fig4}

\}

\textbackslash caption\{Tempo de 5\%\}\label{fig:fig11RA4}
\textbackslash end\{figure\}

\hypertarget{problema-11.2}{%
\section*{Problema 11.2}\label{problema-11.2}}
\addcontentsline{toc}{section}{Problema 11.2}
...
\hypertarget{resoluuxe7uxe3o-40}{%
\subsubsection*{Resolução}\label{resoluuxe7uxe3o-40}}
\addcontentsline{toc}{subsubsection}{Resolução}

Working on it :)

\hypertarget{problema-11.3}{%
\section*{Problema 11.3}\label{problema-11.3}}
\addcontentsline{toc}{section}{Problema 11.3}
...
\tightlist
\item
  Determine um controlador avanço de fase \(C(s)\) considerando que: (i) \(MF \geq20^\circ\) e (ii) \(K_v \geq 20\).
\item
  Verifique que o controlador obtido realmente atende tais especificações.
\end{enumerate}

\hypertarget{resoluuxe7uxe3o-41}{%
\subsubsection{Resolução}\label{resoluuxe7uxe3o-41}}

\hypertarget{parte-a-19}{%
\paragraph{Parte A}\label{parte-a-19}}
\addcontentsline{toc}{paragraph}{Parte A}
...
{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab11/Resolução/fig5} 

}

\caption{Resultado A}\label{fig:fig11RC1}
\end{figure}
...
\[
C(s) = 20\frac{0.1052632s +1}{0.0105263s+1}
\]

\hypertarget{parte-b-19}{%
\paragraph{Parte B}\label{parte-b-19}}
\addcontentsline{toc}{paragraph}{Parte B}
...
{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab11/Resolução/fig6} 

}

\caption{Diagrama de Bode}\label{fig:fig11RC2}
\end{figure}
...
{\centering \includegraphics[width=0.5\linewidth]{Imagens/Lab11/Resolução/fig7} 

}

\caption{Simulação}\label{fig:fig11RC3}
\end{figure}
