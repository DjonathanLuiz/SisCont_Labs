...
\addcontentsline{toc}{subsection}{Pólos e Zeros}
...
\addcontentsline{toc}{section}{Procedimentos doLaboratório 2}
...
\addcontentsline{toc}{subsection}{Modelagem de Sistemas Lineares}
...
\addcontentsline{toc}{subsection}{Identificação de sistemas de primeira ordem}
...
\addcontentsline{toc}{subsection}{Identificação de Sistemas de Segunda Ordem}
...
\addcontentsline{toc}{section}{Procedimentos do Laboratório 3}
...
\addcontentsline{toc}{subsection}{Tipos de Sistemas}
...
\addcontentsline{toc}{subsection}{Erro em regime permanente}
...
\addcontentsline{toc}{section}{Procedimentos do Laboratório 4}
...
\addcontentsline{toc}{subsection}{Controladores Clássicos}
...
\addcontentsline{toc}{subsection}{Método Algébrico de Projeto de Controladores}
...
\addcontentsline{toc}{section}{Procedimentos do Laboratório 5}
