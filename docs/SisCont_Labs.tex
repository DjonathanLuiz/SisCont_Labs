...
O resultado da simulação está apresentado na figura \ref{fig:prob1A1}
...
\caption{Diagrama de blocos do processos $G(s)$ em malha-fechada com perturbação $w$.}\label{fig:prob1A1}
\end{figure}
